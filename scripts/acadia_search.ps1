...
$out = @("# Search Results: ACADIA Rebrand Occurrences", "")
$out += "This report lists all occurrences of the specified strings across the project.", ""

$patterns = "Parent Trust OS|Trust OS|ParentTrust|SchoolOS|SCHOOL OS|NexusOS"
...
$out | Out-File -FilePath 'C:\Users\st\.gemini\antigravity\brain\a258ac0b-8c79-496a-9010-9e4b949a70b3\acadia_search_results.md' -Encoding utf8
