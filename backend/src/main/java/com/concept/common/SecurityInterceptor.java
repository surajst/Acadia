    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        ...
        if (auth != null && auth.isAuthenticated() && !("anonymousUser".equals(auth.getName()))) {
            ...
            if (session.getAttribute("currentUser") == null) {
                ...
                try {
                    com.concept.user.UserRepository userRepo = org.springframework.web.context.support.WebApplicationContextUtils
                        .getRequiredWebApplicationContext(request.getServletContext())
                        .getBean(com.concept.user.UserRepository.class);
                        
                    java.util.Optional<com.concept.user.User> userOpt = userRepo.findByEmail(username);
                    ...
                    if (userOpt.isPresent()) {
                        ...
                        com.concept.user.User mockUser = new com.concept.user.User();
                        ...
                        com.concept.user.UserRole userRole = com.concept.user.UserRole.TEACHER;
                        for (GrantedAuthority authority : auth.getAuthorities()) {
                            String roleName = authority.getAuthority();
                            if (roleName.equals("ROLE_ADMIN")) {
                                userRole = com.concept.user.UserRole.ADMIN;
                            } else if (roleName.equals("ROLE_PARENT")) {
                                userRole = com.concept.user.UserRole.PARENT;
                            }
                        }
