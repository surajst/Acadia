...
public class SubjectApiController {
    ...
    @GetMapping
    public ResponseEntity<List<SubjectView>> listActiveSubjects(Authentication authentication) {
        UUID tenantId = currentUserService.getCurrentTenantId(authentication).orElse(null);
        return ResponseEntity.ok(subjectService.activeSubjectViews(tenantId));
    }
}
