...
(async () => {
  ...
  // Navigate to student rosters to see classes
  await page.goto('http://localhost:8080/web/teacher/rosters');
  await page.waitForLoadState('load');
  await page.waitForTimeout(600);
  await page.screenshot({ path: 'd:\\Development\\parent-trust-os\\backend\\src\\test\\e2e\\teacher_rosters_3classes.png', fullPage: true });
